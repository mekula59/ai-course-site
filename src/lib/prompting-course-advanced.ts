...
export const promptingPlaybook: CourseStandaloneLesson = {
  ...
  lesson: {
    ...
    practiceTask: { en: "Choose one prompt from the bank and replace every bracket with details from a real, safe task. Check the CORE, try it, improve the answer once, then note what you checked before using the result.", pidgin: "Choose one prompt from the bank and replace every bracket with details from real task wey safe. Check the CORE, try am, improve the answer once, then note wetin you check before you use the result." },
    quickCheck: [
    ...
    keyTakeaway: { en: "Check the CORE. Use one focused follow-up. Then do your own final check before using the answer.", pidgin: "Check the CORE. Use one focused follow-up. Then do your own final check before you use the answer." },
  },
};
