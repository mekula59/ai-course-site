...
const refiningLessons: Lesson[] = [
  {
    ...
    intro: {
      en: "You get an answer that's close, but the opening is stiff and the useful point is buried. You don't need a brand-new prompt. You need to tell AI what to keep and what to change.",
      pidgin: "AI give you answer wey close, but the opening stiff and the useful point hide. You no need start new prompt. Tell AI wetin e suppose keep and wetin e suppose change.",
    },
    teaching: {
      question: { en: "Why should I fix an answer instead of starting again?", pidgin: "Why I suppose fix answer instead of starting again?" },
      situation: {
  ...
  },
  {
    ...
    title: { en: "Turn One Answer Into Many Versions", pidgin: "Turn One Answer Into Different Versions" },
    intro: { en: "You don't need to write the same update seven times. Start with one accurate source, then adapt it for each place and audience without changing the facts.", pidgin: "You no need write the same update seven times. Start with one correct source, then adapt am for every place and audience without changing the facts." },
    teaching: {
      question: { en: "Can one good answer do more than one job?", pidgin: "One good answer fit do more than one work?" },
      situation: { en: "Your community event details are already correct. Now you need an email, WhatsApp message, Instagram caption, checklist, and short speech. Starting from scratch each time creates extra work and inconsistent details.", pidgin: "Your community event details already correct. Now you need email, WhatsApp message, Instagram caption, checklist, and short speech. To start again every time create extra work and details fit no match." },
      comparison: {
        label: { en: "Adapt, don't duplicate", pidgin: "Adapt am, no duplicate blindly" },
        before: { en: "Turn this into social media posts.", pidgin: "Turn this into social media posts." },
        after: { en: "Using the approved event details below, create: 1) a 70-word email, 2) a WhatsApp reminder, and 3) an Instagram caption. Keep the date, time, venue, and fee exactly the same. Adjust the opening and length for each channel.", pidgin: "Use the approved event details below create: 1) email wey no pass 70 words, 2) WhatsApp reminder, and 3) Instagram caption. Keep date, time, venue, and fee exactly the same. Adjust the opening and length for every channel." },
...
export const promptingRefiningResponsesModule: CourseModule = {
  ...
  number: "03",
  title: { en: "Refining AI Responses", pidgin: "How to Refine AI Answer" },
...
const habitLesson = (
  ...
  content: [
    ...
    { heading: { en: "Pause and make one decision", pidgin: "Pause and make one decision" }, body: { en: "Before you continue, choose one real task you repeat. What would make the next attempt quicker without making the prompt rigid? Write that down.", pidgin: "Before you continue, choose one real task wey you dey repeat. Wetin go make the next attempt quicker without making the prompt too rigid? Write am down." } },
    { heading: { en: "Try this with real work", pidgin: "Try this with real work" }, body: { en: "Use the prompt below for something you already do. A useful habit should save thinking next time while still leaving room for the details that change.", pidgin: "Use the prompt below for something wey you already dey do. Useful habit suppose save thinking next time and still leave space for details wey fit change." } },
  ],
...
export const promptingBetterHabitsModule: CourseModule = {
  ...
  lessons: [
    habitLesson(
      ...
      { en: "Save Prompts You'll Reuse", pidgin: "Save Prompts Wey You Go Use Again" },
      ...
      { en: "You remember a customer-reply prompt worked well last month, but you can't find it. Your chat history is full, and the wording you need is buried. Let's give useful prompts a proper home.", pidgin: "You remember say one customer-reply prompt work well last month, but you no fit find am. Your chat history full and the wording hide. Make we give useful prompts proper home." },
    ...
    habitLesson(
      ...
      [
        { label: { en: "Fixed parts", pidgin: "Parts wey remain" }, content: { en: "The task, quality checks, and useful output structure.", pidgin: "The task, quality checks, and useful output structure." } },
      ...
      { en: "A template keeps the useful decisions and exposes the details that must change. Test it twice before trusting it.", pidgin: "Template keep the useful decisions and expose the details wey must change. Test am twice before you trust am." }
    ),
    habitLesson(
      ...
      { en: "The improved list begins with real behaviour. Each task can earn one tested template.", pidgin: "The improved list start with real behaviour. Every task fit get one tested template." },
      ...
      { en: "List ten tasks you repeat. Circle five that are frequent, safe to use with AI, and easy to review. Build one toolkit entry today, not all five.", pidgin: "List ten tasks wey you dey repeat. Circle five wey frequent, safe to use with AI, and easy to review. Build one toolkit entry today, no be all five." },
...
const promptBank = {
  en: "1. Explain [topic] to [level] using [example], then ask me two questions.\n2. Turn these notes into a clear WhatsApp message for [audience].\n3. Rewrite this email to sound [tone] while keeping every fact.\n4. Summarise these meeting notes into decisions, owners, and deadlines.\n5. Reply to this customer complaint calmly and give the next step.\n6. Create a seven-day study plan for [topic] with [time] each day.\n7. Compare [options] in a table using [criteria].\n8. Turn this announcement into email, WhatsApp, and Instagram versions.\n9. Shorten this to [length] without removing [important point].\n10. Make this answer more specific using examples from [context].\n11. Check this draft for unclear claims and questions a reader may have.\n12. Create a checklist for [event or task] grouped by [stages].\n13. Write a professional application email using only these facts: [facts].\n14. Turn these rough ideas into a weekly content plan for [audience].\n15. Give me three caption openings for [product], without inventing claims.\n16. Explain what is weak in this answer before rewriting it.\n17. Keep [parts], change [parts], and remove [parts] from your last answer.\n18. Ask me up to three questions before planning [task].\n19. Show me the assumptions in your answer and which facts I should verify.\n20. Turn this tested prompt into a reusable template with [brackets].\n21. Help me choose the five repeated tasks worth adding to my toolkit.\n22. Give me one hint for [problem] without giving the full answer.",
  pidgin: "1. Explain [topic] to [level] with [example], then ask me two questions.\n2. Turn these notes into clear WhatsApp message for [audience].\n3. Rewrite this email make e sound [tone] while you keep every fact.\n4. Summarise these meeting notes into decisions, who dey responsible, and deadlines.\n5. Reply this customer complaint calmly and give the next step.\n6. Create seven-day study plan for [topic] with [time] every day.\n7. Compare [options] for table with [criteria].\n8. Turn this announcement into email, WhatsApp, and Instagram versions.\n9. Shorten this reach [length] without removing [important point].\n10. Make this answer more specific with examples from [context].\n11. Check this draft for unclear claims and questions wey reader fit get.\n12. Create checklist for [event or task] grouped by [stages].\n13. Write professional application email using only these facts: [facts].\n14. Turn these rough ideas into weekly content plan for [audience].\n15. Give me three caption openings for [product], no invent claims.\n16. Explain wetin weak for this answer before you rewrite am.\n17. Keep [parts], change [parts], and remove [parts] from your last answer.\n18. Ask me up to three questions before you plan [task].\n19. Show me the assumptions for your answer and which facts I suppose verify.\n20. Turn this tested prompt into reusable template with [brackets].\n21. Help me choose the five repeated tasks wey worth adding to my toolkit.\n22. Give me one hint for [problem] without giving the full answer.",
};
...
export const promptingPlaybook: CourseStandaloneLesson = {
  ...
  lesson: {
    ...
    content: [
      { heading: { en: "The prompt checklist", pidgin: "Prompt checklist" }, body: { en: "Task: What should AI do?\nContext: What background changes the answer?\nRequirements: Which facts, limits, or boundaries matter?\nOutput: What form will be easiest to use?\nReview: What must you check before using it?", pidgin: "Task: Wetin AI suppose do?\nContext: Which background go change the answer?\nRequirements: Which facts, limits, or boundaries matter?\nOutput: Which form go easy to use?\nReview: Wetin you must check before you use am?" } },
      ...
      { heading: { en: "What to avoid", pidgin: "Wetin to avoid" }, body: { en: "Don't paste private information you don't need. Don't ask AI to impersonate someone deceptively. Don't trust dates, prices, sources, calculations, or important claims without checking. Don't crowd a prompt with details that don't affect the answer. Don't keep refining a bad direction when starting with corrected facts would be safer.", pidgin: "No paste private information wey you no need. No ask AI to impersonate person deceptively. No trust dates, prices, sources, calculations, or important claims without checking. No crowd prompt with details wey no affect the answer. No continue to refine wrong direction when e safer to start with corrected facts." } },
      { heading: { en: "22 prompts to keep", pidgin: "22 prompts wey you fit keep" }, body: promptBank },
      { heading: { en: "A ten-minute practice routine", pidgin: "Ten-minute practice routine" }, body: { en: "Minutes 1-2: choose one real, safe task.\nMinutes 3-4: write a first prompt using task, context, requirements, and output.\nMinutes 5-6: read the answer and name one gap.\nMinutes 7-8: give one focused follow-up.\nMinutes 9-10: check the facts and save the prompt only if it earned a place in your toolkit.\n\nDo this once or twice a week. Good habits come from using prompts, not collecting them.", pidgin: "Minutes 1-2: choose one real, safe task.\nMinutes 3-4: write first prompt with task, context, requirements, and output.\nMinutes 5-6: read the answer and name one gap.\nMinutes 7-8: give one focused follow-up.\nMinutes 9-10: check the facts and save the prompt only if e earn space for your toolkit.\n\nDo am once or twice every week. Good habits dey come from using prompts, no be collecting dem." } },
    ],
    examplePrompt: promptBank,
    practiceTask: { en: "Choose one prompt from the bank and replace every bracket with details from a real, safe task. Try it, refine the answer once, then note what you checked before using the result.", pidgin: "Choose one prompt from the bank and replace every bracket with details from real, safe task. Try am, refine the answer once, then note wetin you check before you use the result." },
    quickCheck: [
    ...
    keyTakeaway: { en: "Clear task. Useful context. Right tone and format. One focused follow-up. Your own final check.", pidgin: "Clear task. Useful context. Correct tone and format. One focused follow-up. Your own final check." },
  },
};
