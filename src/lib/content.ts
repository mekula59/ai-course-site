...
const en: SiteContent = {
  ...
  hero: {
    eyebrow: "Beginner AI Course",
    headline: "AI is changing everything.",
    headlineAccent: "Start using it.",
    sub: "You already use Google, WhatsApp, and YouTube. Learning to use AI is no different. This course shows you how, step by step, in plain English and Nigerian Pidgin.",
...
const pidgin: SiteContent = {
  ...
  hero: {
    eyebrow: "AI Course for Beginners",
    headline: "AI don dey change everything.",
    headlineAccent: "Start use am.",
    sub: "You dey already use Google, WhatsApp, and YouTube. Learning how to use AI no different. This course go show you how, step by step, for clear English and Nigerian Pidgin.",
    primaryCta: "Get Early Access",
    secondaryCta: "See the Course",
