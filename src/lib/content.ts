...
const en: SiteContent = {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. You can start the free course now. Leave your details if you want updates about new lessons, live sessions, workshops, and future course drops.",
      },
    ],
  },
  promptDemo: {
  ...
  updates: {
    ...
    submitCta: "Get Course Updates",
    submittingLabel: "Sending...",
    trustItems: ["Free updates", "No spam", "New lessons and sessions"],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. You fit start the free course now. Drop your details if you want updates about new lessons, live sessions, workshops, and future course drops.",
      },
    ],
  },
  promptDemo: {
