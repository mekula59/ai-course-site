...
const en: SiteContent = {
  ...
  hero: {
    eyebrow: "Beginner AI Course · Built for Nigeria",
    headline: "AI is not for tech people.",
    headlineAccent: "It never was.",
    sub: "You already use Google, WhatsApp, and YouTube. AI tools are no different. This course shows you how to use them for real work, business, and daily life, in plain English and Nigerian Pidgin.",
...
const pidgin: SiteContent = {
  ...
  hero: {
    eyebrow: "AI Course for Beginners · Nigeria",
    headline: "AI no be for tech people.",
    headlineAccent: "E never be.",
    sub: "You dey already use Google, WhatsApp, and YouTube. AI tools na the same thing. This course go show you how to use dem for work, business, and daily life, for plain English and Nigerian Pidgin.",
    primaryCta: "Get Early Access",
    secondaryCta: "See the Course",
